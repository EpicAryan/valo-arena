                ...
                <div>
                    <div className="mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg">
                        ...
                        >
                            <video
                                ref={nextVideoRef}
                                src={videoSources[upcomingVideoIndex - 1]}
                                playsInline
                                loop
                                muted
                                id="current-video"
                    ...
                    <video 
                        ref={nextVideoRef}
                        src={videoSources[currentIndex - 1]}
                        playsInline
                        loop
                        muted
                        id="next-video"
                    ...
                    />
                    <video
                        src={videoSources[currentIndex === totalVideos - 1 ? 0 : currentIndex - 1]}
                        autoPlay
                        playsInline
                        loop
                        muted
                        ...
                        <div className="md:ml-3">
                            ...
                            <a href="https://playvalorant.com/en-us/" target="_blank" rel="noopener noreferrer">
                                <Button 
                                    ...
                                    containerClass="!bg-red-secondary/90 text-white flex-center gap-1 shadow-md shadow-red-primary/40 hover:!bg-red-tertiary/90 hover:shadow-red-primary/50" 
                                />
                            </a>
                        </div>
                    </div>
